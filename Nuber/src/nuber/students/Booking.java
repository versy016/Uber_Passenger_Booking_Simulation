 ...
 * This should be multithread friendly, allowing bookings to be created from different threads.
 *
 * @author James
 *
 */
public class Booking implements Callable<BookingResult>{
	...
	public Booking(NuberDispatch dispatch, Passenger passenger)
	{
		...
		jobid = this.dispatch.bookingCount.incrementAndGet();
	...
	public BookingResult call() throws InterruptedException {
		...
		tripduration = new Date().getTime()-tripduration ;
